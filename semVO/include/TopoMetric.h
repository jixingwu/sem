...
public:
    ...
    // set edge as visited
    void setVisitedEdge(int id_node_1, int id_node_2);
    ...
    // back up neibor node of zero node(0,0,0)
    // void backUpZeroNeibor(Eigen::Vector3d xyz){zero_neibor_xyz_vec.push_back(xyz);}
    // void clearBackUpNeibor(){zero_neibor_xyz_vec.clear();}
    // vector<Eigen::Vector3d> zero_neibor_xyz_vec;
